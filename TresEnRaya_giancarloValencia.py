# Hay que tener el pip actualizado con: pip install --upgrade pip 
# Luego hay que instalar la librería de pygame con: pip install pygame
# Adecuado a python 3.7 a +
